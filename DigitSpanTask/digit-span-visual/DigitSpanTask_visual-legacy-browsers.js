...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'datasets/training_AF.xlsx', 'path': 'datasets/training_AF.xlsx'},
    {'name': 'datasets/instructions.xlsx', 'path': 'datasets/instructions.xlsx'},
    {'name': 'datasets/training_AR.xlsx', 'path': 'datasets/training_AR.xlsx'},
    {'name': 'datasets/instruccion2.png', 'path': 'datasets/instruccion2.png'},
    {'name': 'datasets/drift.png', 'path': 'datasets/drift.png'},
    {'name': 'datasets/training_PF.xlsx', 'path': 'datasets/training_PF.xlsx'},
    ...
    {'name': 'datasets/Dataset_AF.xlsx', 'path': 'datasets/Dataset_AF.xlsx'},
    {'name': 'datasets/Dataset_PF.xlsx', 'path': 'datasets/Dataset_PF.xlsx'},
    {'name': 'datasets/Dataset_PR.xlsx', 'path': 'datasets/Dataset_PR.xlsx'},
    {'name': 'datasets/Dataset_AR.xlsx', 'path': 'datasets/Dataset_AR.xlsx'}
  ]
});
...
function Bienvenida2RoutineBegin(snapshot) {
  return async function () {
    ...
    Bienvenida2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Block_OrderLoopBegin(Block_OrderLoopScheduler, snapshot) {
  return async function() {
    ...
    Block_Order = new TrialHandler({
      ...
      trialList: TrialHandler.importConditions(psychoJS.serverManager, 'datasets/task_order.xslx', lasfilas),
...
function instrucloop_PasivasLoopBegin(instrucloop_PasivasLoopScheduler, snapshot) {
  return async function() {
    ...
    instrucloop_Pasivas = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.SEQUENTIAL,
      extraInfo: expInfo, originPath: undefined,
      trialList: 'datasets/instructions.xslx',
    ...
    // Schedule all the trials in the trialList:
    instrucloop_Pasivas.forEach(function() {
...
function trial_trainingPasivasLoopBegin(trial_trainingPasivasLoopScheduler, snapshot) {
  return async function() {
    ...
    trial_trainingPasivas = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.SEQUENTIAL,
      extraInfo: expInfo, originPath: undefined,
      trialList: (("datasets/training_" + ordenpasivas[BlockPasivas.thisN]) + ".xslx"),
    ...
    // Schedule all the trials in the trialList:
    trial_trainingPasivas.forEach(function() {
...
function train_digitloopPasivasLoopBegin(train_digitloopPasivasLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    train_digitloopPasivas.forEach(function() {
...
function trial_PasivaLoopBegin(trial_PasivaLoopScheduler, snapshot) {
  return async function() {
    ...
    trial_Pasiva = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.SEQUENTIAL,
      extraInfo: expInfo, originPath: undefined,
      trialList: (("datasets/Dataset_" + ordenpasivas[BlockPasivas.thisN]) + ".xslx"),
...
function digitLoop_PasivasLoopBegin(digitLoop_PasivasLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    digitLoop_Pasivas.forEach(function() {
...
function intrLoopActivasLoopBegin(intrLoopActivasLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    intrLoopActivas.forEach(function() {
...
function trial_train_ActivasLoopBegin(trial_train_ActivasLoopScheduler, snapshot) {
  return async function() {
    ...
    trial_train_Activas = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.SEQUENTIAL,
      extraInfo: expInfo, originPath: undefined,
      trialList: (("datasets/training_" + ordenactivas[BlockActivas.thisN]) + ".xslx"),
    ...
    // Schedule all the trials in the trialList:
    trial_train_Activas.forEach(function() {
...
function train_digitloop_ActivasLoopBegin(train_digitloop_ActivasLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    train_digitloop_Activas.forEach(function() {
...
function trialActivasLoopBegin(trialActivasLoopScheduler, snapshot) {
  return async function() {
    ...
    trialActivas = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.SEQUENTIAL,
      extraInfo: expInfo, originPath: undefined,
      trialList: (("datasets/Dataset_" + ordenactivas[BlockActivas.thisN]) + ".xslx"),
...
function digitLoop_ActivasLoopBegin(digitLoop_ActivasLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    digitLoop_Activas.forEach(function() {
...
function InstruccionesPasivaRoutineBegin(snapshot) {
  return async function () {
    ...
    InstruccionesPasivaComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Presentation_pasRoutineBegin(snapshot) {
  return async function () {
    ...
    Presentation_pasComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Recall_pasivasRoutineBegin(snapshot) {
  return async function () {
    ...
    Recall_pasivasComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function post_recallPasivaRoutineBegin(snapshot) {
  return async function () {
    ...
    post_recallPasivaComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function LickertPasivasRoutineBegin(snapshot) {
  return async function () {
    ...
    LickertPasivasComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function EndTaskRoutineBegin(snapshot) {
  return async function () {
    ...
    EndTaskComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Instr_ActivasRoutineBegin(snapshot) {
  return async function () {
    ...
    Instr_ActivasComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function drift_press_activasRoutineBegin(snapshot) {
  return async function () {
    ...
    drift_press_activasComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ffix_trainactivasRoutineBegin(snapshot) {
  return async function () {
    ...
    ffix_trainactivasComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function present_train_activasRoutineBegin(snapshot) {
  return async function () {
    ...
    present_train_activasComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function recall_train_activasRoutineBegin(snapshot) {
  return async function () {
    ...
    recall_train_activasComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function post_recall_train_activasRoutineBegin(snapshot) {
  return async function () {
    ...
    post_recall_train_activasComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function start_trialActivasRoutineBegin(snapshot) {
  return async function () {
    ...
    start_trialActivasComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function first_fixActivasRoutineBegin(snapshot) {
  return async function () {
    ...
    first_fixActivasComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function PresentationActivasRoutineBegin(snapshot) {
  return async function () {
    ...
    PresentationActivasComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function RecallActivasRoutineBegin(snapshot) {
  return async function () {
    ...
    RecallActivasComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function post_recallActivasRoutineBegin(snapshot) {
  return async function () {
    ...
    post_recallActivasComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function LickertActivasRoutineBegin(snapshot) {
  return async function () {
    ...
    LickertActivasComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;

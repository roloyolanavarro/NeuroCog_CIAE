...
expName = 'DigitSpanTask_AF'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\INU\\Documents\\GitHub\\NeuroCog_CIAE\\DigitSpanTask\\digit-span-visual\\DigitSpanTask_AF.py',
...
start_AF = sound.Sound('datasets/microwave-beep.wav', secs=0.5, stereo=True, hamming=True,
    name='start_AF')
...
trial_trainingAF = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('datasets/training_af.xlsx'),
...
trial_AF = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('datasets/Dataset_AF.xlsx'),
...
for thisTrial_AF in trial_AF:
    ...
    continueRoutine = True
    # update component parameters for each repeat
    start_AF.setSound('datasets/microwave-beep.wav', secs=0.5, hamming=True)

...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\INU\\Documents\\GitHub\\NeuroCog_CIAE\\TaskTemplates\\PsychoPy_tasks\\digit-span-fwd\\DigitSpanTask_PR_lastrun.py',
...
drift_trainPR = visual.ImageStim(
    ...
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
start_trainPR = sound.Sound('microwave-beep.wav', secs=0.5, stereo=True, hamming=True,
    name='start_trainPR')
...
driftPR = visual.ImageStim(
    ...
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
startPR = sound.Sound('microwave-beep.wav', secs=0.5, stereo=True, hamming=True,
    name='startPR')
...
trial_trainingPR = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('training_pr.xlsx'),
...
for thisTrial_trainingPR in trial_trainingPR:
    ...
    continueRoutine = True
    # update component parameters for each repeat
    start_trainPR.setSound('microwave-beep.wav', secs=0.5, hamming=True)
...
trial_PR = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('Dataset_PR.xlsx'),
...
for thisTrial_PR in trial_PR:
    ...
    continueRoutine = True
    # update component parameters for each repeat
    startPR.setSound('microwave-beep.wav', secs=0.5, hamming=True)

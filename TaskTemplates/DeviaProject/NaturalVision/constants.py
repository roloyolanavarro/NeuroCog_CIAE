...
LOGFILENAME = 'ir2' # logfilename, without path
...
SCREENSIZE = (60.0, 34.0) # physical display size in cm
...
SACCVELTHRESH = 30 # degrees per second, saccade velocity threshold
SACCACCTHRESH = 4000 # degrees per second, saccade acceleration threshold
# EyeLink only
# SMI only
SMIIP = '127.0.0.1'
SMISENDPORT = 4444
